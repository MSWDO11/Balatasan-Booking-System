...
import { Waves, LayoutDashboard, Database, LogOut, Eye, Bell, Star } from "lucide-react";
...
export function AdminNavbar() {
  ...
  // Watch for Payment Uploaded bookings — these are the admin's actionable notifications
